...
$(document).ready(function(){
    ...
    const mostraMsgMes = (texto) =>{
        ...
        switch(texto){
            case "24/3": titulo = "24 de Março de 2023"; mensagem = "<p>Esse foi o dia que nos conhecemos! Pensa em uma garota que só sabia rir e falar não tô te entendendo tava tão nervosa em te conhecer nem sabia que esse seria um dos dias mais importantes da minha vida!</p>";break;
            case "1/4": titulo = "01 de Abril de 2023"; mensagem = "<p>Foi o dia da minha festa de 15 anos, momo você tava lindooo e eu só sabia te olharrr❤️</p>";break;
            case "28/3": titulo = "28 de Março de 2023"; mensagem = "<p>Foi quando eu fiquei adimirada com vc momo na praça sentados no banco, aquele banco me marcou tanto que sempre olho pra ele, como toda vez que vou no shibata faço quetão de ver se nossas inicias estão no estacionamento. </p>";break;
            case "final": titulo = "25 de Outubro de 2023"; mensagem = "<section class='text-center mt-5 mb-5'><p><strong>O dia em que ele disse<br><span class='letra2 letra-vermelha'>SIM</span></strong></p></section>";break;
        }
